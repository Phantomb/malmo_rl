...
class Agent(BaseAgent):
    def __init__(self, params: argparse, port: int, start_malmo: bool, agent_index: int) -> None:
        ...
        self.maximal_number_of_steps = 60 # episode length is 30 for single DSNs, 60 for 2-room, 100 for 3-room
        
        # Global Variables
        self.number_of_steps = 0

        # Load 
        self.models = self.loadSkillModels()

    def loadSkillModels(self):
        # Load the trained models for all subskills
        return
