...
parser.add_argument('--hist_len', type=int, default=4, help='Number of observations that create a "state".')
...
parser.add_argument('--normalize_reward', default=False, action='store_true',
                    help='Normalize rewards such that Q is in the range of [-1,1]. This is not reward clipping.')
...
parser.add_argument('--srm_decay', type=int, default=0,
                    help='Over how many steps does this linear probability decay take place. When this is 0, srm probability will default to srm_end. Default = 0 steps.')
